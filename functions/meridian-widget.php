...
class Meridian_widget1 extends WP_Widget {
    function Meridian_widget1() {
        $widget_ops = array('description' => 'Meridian主题：热门文章（需要WP-PostViews插件）');
        $this->WP_Widget('Meridian_widget1', 'Meridian：热门文章', $widget_ops);
    }
...
add_action('widgets_init', 'Meridian_widget1_init');
function Meridian_widget1_init() {
    register_widget('Meridian_widget1');
}
